...
# print("=" * 30)
# EMAIL_ACCOUNT = input("Enter company sandbox Gmail address: ").strip()
# APP_PASSWORD = getpass.getpass("Enter your 16-character Google App Password: ").strip()
# print("=" * 30 + "\n")


EMAIL_ACCOUNT = "test.roni.auditor@gmail.com"
APP_PASSWORD = "rlvq gcta tsyh dvld"
